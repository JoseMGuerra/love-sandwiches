...
def validate_data(values):
    '''
    Inside the try, all string values into integers.
...
#     '''
#     Update surplus worksheet, add a row with new surplus data calculation.
#     '''
...
def update_worksheet(data, worksheet):
    ...
    Update the relevant worksheet with new data provided.
    '''
...
def get_last_entries_sales():
    '''
    Collect columns of data from sales worksheet, collecting the last
